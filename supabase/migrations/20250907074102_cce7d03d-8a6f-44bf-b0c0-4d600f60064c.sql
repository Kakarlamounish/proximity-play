...
-- Drop and recreate meetup policies
...
-- Drop and recreate meetup_rsvps policies
...
-- Drop and recreate user_blocks policies
...
-- Drop and recreate user_reports policies
...
-- Drop and recreate badges policies
...
-- Drop and recreate user_badges policies
...
-- Add remaining storage policies
...
-- Try to enable realtime for tables that might not have it yet
DO $$
BEGIN
